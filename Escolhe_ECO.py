...
def escolher_ECO(responsavel, janela):
    ...
    campo_4.configure(bg="#DDEBF7", highlightbackground="#205A8C",
                      highlightthickness=1, borderwidth=0)
    botao_2 = tk.Button(janela2, text="Avançar", font=("Poppins", 8),  bg="#205A8C", fg="white", activebackground="#205A8C",
    ...
    # Adiciona a imagem
    path = os.path.abspath(r'\\terra\GER_PRODUTOS\0 GPd\10 - Trabalhos desenvolvidos\Inserir alternativos - Automação\Arquivos\featured_channel.png')
    ...
    label_imagem.grid(row=5, column=3, pady=(0,20), sticky="NW")
