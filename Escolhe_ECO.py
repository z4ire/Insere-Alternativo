...
def escolher_ECO(responsavel, janela):
    ...
    label_4 = tk.Label(janela2, text="Ano da ECO", font=("calibri", 12), bg="#EAEAEA")
    label_5 = tk.Label(janela2, text="Número da ECO", font=("calibri", 12), bg="#EAEAEA")
    ...
    botao_2 = tk.Button(janela2, text="Disponibilizar", bg="#205A8C", fg="white", activebackground="#205A8C", activeforeground="white", command=lambda: cria_path(str(campo_3.get()), str(campo_4.get()), responsavel, janela2))
    ...
    label_imagem.grid(row=6, column=3, pady=10, sticky="NW")
