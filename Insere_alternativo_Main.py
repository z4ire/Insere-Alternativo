...
class LoginApp:
    def __init__(self, master):
        ...
        label_login = tk.Label(master, text="Usuário",font=("Poppins", 10), bg="#EAEAEA")
        label_senha = tk.Label(master, text="Senha",font=("Poppins", 10), bg="#EAEAEA")
        ...
        botao_acessar = tk.Button(text="Acessar", font=("Poppins", 8), bg="#205A8C", fg="white", activebackground="#205A8C", activeforeground="white", command=self.validar_usuario)
        ...
        # Adiciona a imagem
        path = os.path.abspath(r"\\terra\GER_PRODUTOS\0 GPd\10 - Trabalhos desenvolvidos\Inserir alternativos - Automação\Arquivos\logo-padtec.png")
    ...
    def validar_usuario(self):
        ...
        if resultado is not True:
            self.label_erro.configure(text="Usuário e/ou senha incorreto(s)", font=("Poppins", 8))
