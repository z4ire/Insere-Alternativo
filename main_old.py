...
class LoginApp:
    def __init__(self, master):
        ...
        label_login = tk.Label(master, text="Usuário",
                               font=("calibri", 12), bg="#EAEAEA")
        label_senha = tk.Label(master, text="Senha",
                               font=("calibri", 12), bg="#EAEAEA")
        ...
        botao_acessar = tk.Button(
            text="Acessar", bg="#205A8C", fg="white", activebackground="#205A8C", activeforeground="white", command=self.validar_usuario)
